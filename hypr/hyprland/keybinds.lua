...
-- Apps
create_bind(vars.kbTerminal, fn.toggle("scratch-terminal"))
create_bind(vars.kbGoogleChrome, fn.toggle("scratch-chrome"))
create_bind(vars.kbDiscord, fn.toggle("scratch-discord"))
create_bind(vars.kbWhatsapp, fn.toggle("scratch-whatsapp"))
create_bind(vars.kbTelegram, fn.toggle("scratch-telegram"))
create_bind(vars.kbMusic, fn.toggle("scratch-spotify"))
create_bind(vars.kbBrowser, fn.launch_or_focus(vars.browser, "zen"))
create_bind(vars.kbEditor, fn.launch_or_focus(vars.editor, "dev.zed.Zed"))
create_bind(vars.kbFileExplorer, fn.launch_or_focus(vars.fileExplorer, "thunar"))
create_bind(vars.kbTermius, fn.launch_or_focus(vars.termius, "Termius"))
create_bind(vars.kbPostman, fn.launch_or_focus(vars.postman, "Postman"))
